...
**B站视频的音频文件编码方式存在兼容性问题，如果出现下载的视频用系统播放器播放时报错（例如“Windows 媒体播放器无法播放该文件”或黑屏无声音），请尝试使用vlc media player或potplayer播放视频。如果仍然无法解决问题，请在issue中反馈**
...
-  **全屏自动隐藏**：系统全屏与 B 站“网页全屏”播放时自动隐藏界面，退出全屏后恢复，不遮挡视频
...
1. 下载本项目代码（在release页面下载最新版压缩包或`Code → Download ZIP` 并解压）
2. 打开浏览器扩展管理页：
...
| 无法下载某些视频 | 出于版权考虑，付费购买、充电视频 / 大会员专享 / 需要额外权限的内容无法下载，请遵守平台规则 |
